-- ==========================================
-- Thunder ERP v2 - Production Data Cleanup
-- ==========================================
-- Bu script üretim ile ilgili tüm verileri temizler
...
-- ==========================================
-- 9. Users (Kullanıcılar) - Sadece operatörler
-- ==========================================
-- Operatör kullanıcılarını sil
DELETE FROM users WHERE role = 'operator';

-- ==========================================
-- 10. Operators (Operatörler)
-- ==========================================
DELETE FROM operators;

-- ==========================================
-- 11. Settings (Sistem Ayarları) - Sıfırla
-- ==========================================
UPDATE settings SET 
  company_name = 'Thunder ERP',
  company_address = '',
  company_phone = '',
  company_email = '',
  currency = 'TRY',
...
UNION ALL
SELECT 
  'users (operators only)' as table_name, 
  COUNT(*) as remaining_records 
...
-- 14. Success Message
-- ==========================================
SELECT 'Production data cleanup completed successfully!' as message;
