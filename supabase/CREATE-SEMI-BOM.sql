...
-- Önce yarı mamul ürünün ID'sini bul
DO $$
DECLARE
    product_id UUID;
...
BEGIN
    ...
    IF raw_material_id IS NOT NULL THEN
        INSERT INTO bom (product_id, material_id, material_type, quantity, created_at, updated_at)
...
SELECT '✅ SEMI BOM CREATED!' as result;
