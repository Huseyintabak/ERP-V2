-- 🔧 REMOVE AUDIT TRIGGERS CASCADE: Audit trigger'ları cascade ile kaldır
-- Bu dosya audit trigger'ları cascade ile kaldırır
...
-- 2. Diğer audit trigger'ları da kaldır
...
-- 3. Audit fonksiyonlarını cascade ile kaldır
...
SELECT '✅ AUDIT TRIGGERS REMOVED CASCADE - TRANSFER FUNCTION FIXED!' as result;
