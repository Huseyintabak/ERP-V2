-- 🔧 ALTERNATIVE TRANSFER FUNCTION: Simple Transfer Without Any Triggers
-- Bu dosya basit bir transfer fonksiyonu oluşturur

-- 1. Mevcut transfer fonksiyonunu kaldır
DROP FUNCTION IF EXISTS transfer_between_zones(UUID, UUID, UUID, INTEGER, UUID);

-- 2. Basit transfer fonksiyonu oluştur
...
SELECT '✅ ALTERNATIVE TRANSFER FUNCTION CREATED!' as result;
