-- 🔧 AGGRESSIVE TRANSFER FIX: Remove ALL Triggers and Recreate Everything
-- Bu dosya tüm trigger'ları kaldırır ve transfer fonksiyonunu yeniden oluşturur

-- 1. Tüm trigger'ları kaldır (tüm tablolardan)
...
-- 6. Tüm trigger'ları tekrar kontrol et
SELECT '✅ AGGRESSIVE TRANSFER FIX APPLIED - ALL TRIGGERS REMOVED!' as result;
